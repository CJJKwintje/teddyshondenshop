...
// Fetch all required Contentful data and write to public/contentful-data.json
async function fetchAndWriteContentfulData() {
  ...
  const outputPath = path.join(__dirname, '..', 'public', 'contentful-data.json');
...
async function prerender() {
  // Fetch and write Contentful data first
  await fetchAndWriteContentfulData();

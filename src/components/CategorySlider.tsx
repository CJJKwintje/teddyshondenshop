        ...
        {contentfulCategories.map((category, index) => {
          ...
          return (
            <Link
              ...
              className="flex-none w-[calc(50%-1rem)] sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1rem)] xl:w-[calc(25%-1rem)] snap-start relative rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden group h-48"
            >
              {backgroundImage ? (
                <div 
